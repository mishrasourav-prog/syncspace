...
function useCurrentWorkspaceId(): string | undefined {
...
function DashboardNav() {
    ...
    return (
        <nav className="flex-1 overflow-y-auto px-3 pt-4">
            ...
            <div className="mt-6">
                <p className="px-3 text-caption uppercase tracking-wide">
                    Workspaces
                </p>
