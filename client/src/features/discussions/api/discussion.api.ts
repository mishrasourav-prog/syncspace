...
export async function getProjectDiscussionsRequest(
  projectId: string,
  search: string,
): Promise<DiscussionListResult> {
  return axiosClient
    .get<ApiResponse<DiscussionListResult>>(
...
export async function getDiscussionByIdRequest(
  discussionId: string,
): Promise<Discussion> {
  return axiosClient
    .get<ApiResponse<Discussion>>(`/discussions/${discussionId}`)
    .then((res) => res.data.data);
}
...
export async function pinDiscussionRequest(
  discussionId: string,
): Promise<Discussion> {
  return axiosClient
    .patch<ApiResponse<Discussion>>(`/discussions/${discussionId}/pin`)
    .then((res) => res.data.data);
}

export async function unpinDiscussionRequest(
  discussionId: string,
): Promise<Discussion> {
  return axiosClient
...
export async function lockDiscussionRequest(
  discussionId: string,
): Promise<Discussion> {
  return axiosClient
    .patch<ApiResponse<Discussion>>(`/discussions/${discussionId}/lock`)
    .then((res) => res.data.data);
}

export async function unlockDiscussionRequest(
  discussionId: string,
): Promise<Discussion> {
  return axiosClient
...
export async function getDiscussionRepliesRequest(
  ...
  return axiosClient
    .get<ApiResponse<DiscussionReplyListResult>>(
...
export async function createDiscussionReplyRequest(
  ...
  return axiosClient
    .post<ApiResponse<DiscussionReply>>(
      `/discussions/${discussionId}/replies`,
      payload,
    )
    .then((res) => res.data.data);
...
export async function updateDiscussionReplyRequest(
  ...
  return axiosClient
    .patch<ApiResponse<DiscussionReply>>(
