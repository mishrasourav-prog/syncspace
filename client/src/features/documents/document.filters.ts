...
export type DocumentUpdatedFilter =
  | "today"
  | "week"
  | "month"
  | "older";

export type DocumentRevisionFilter =
  | "any"
  | "one"
  | "two-plus"
  | "five-plus";
...
export const SORT_LABEL: Record<
  DocumentSort,
  string
> = {
  newest:
...
export const UPDATED_LABEL: Record<
...
export const REVISION_LABEL: Record<
  DocumentRevisionFilter,
  string
> = {
  any:
    "Any revision",
