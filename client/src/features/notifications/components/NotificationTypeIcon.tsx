...
const TYPE_STYLES: Record<NotificationType, { icon: typeof UserRoundCheck; classes: string }> = {
  ...
  "task.assignment_requested": { icon: HandHelping, classes: "bg-warning/15 text-warning" },
  "task.assignment_request_accepted": { icon: ShieldCheck, classes: "bg-success/15 text-success" },
  "discussion.created": { icon: MessageSquarePlus, classes: "bg-primary/15 text-primary" },
  ...
  "project.invitation": { icon: FolderKanban, classes: "bg-primary/15 text-primary" },
  "workspace.role_changed": { icon: ShieldCheck, classes: "bg-warning/15 text-warning" },
  "project.role_changed": { icon: ShieldCheck, classes: "bg-warning/15 text-warning" },
  "workspace.member_joined": { icon: UserPlus, classes: "bg-success/15 text-success" },
  "project.member_joined": { icon: UserPlus, classes: "bg-success/15 text-success" },
};
