...
export async function getPendingProjectInvitationsRequest(
  ...
  return axiosClient
    .get<ApiResponse<{ invitations: ProjectInvitation[] }>>(
      `/projects/${projectId}/invitations`,
    )
    .then((res) => res.data.data.invitations);
}

export async function getMyProjectInvitationsRequest(): Promise<
  ProjectInvitation[]
> {
  return axiosClient
    .get<ApiResponse<{ invitations: ProjectInvitation[] }>>(
...
export async function acceptProjectInvitationRequest(
  invitationId: string,
): Promise<void> {
...
export async function rejectProjectInvitationRequest(
  invitationId: string,
): Promise<void> {
  await axiosClient.post<ApiResponse<void>>(
...
export async function cancelProjectInvitationRequest(
  invitationId: string,
): Promise<void> {
