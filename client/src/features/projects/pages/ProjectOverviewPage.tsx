...
import {
    ProjectActivityFeed,
} from "@/features/activity/components/ProjectActivityFeed";
...
} from "@/features/discussions/components/ProjectDiscussionsPreview";
...
import {
    ProjectDocumentsPreview,
} from "@/features/documents/components/ProjectDocumentsPreview";
...
} from "@/features/project-invitations/components/InviteProjectMemberDialog";

import {
    PendingProjectInvitationsPanel,
} from "@/features/project-invitations/components/PendingProjectInvitationsPanel";

import {
    ProjectMembersPanel,
} from "@/features/project-members/components/ProjectMembersPanel";
...
import {
    CreateTaskDialog,
} from "@/features/tasks/components/CreateTaskDialog";

import {
    ProjectCompletionPanel,
} from "@/features/tasks/components/ProjectCompletionPanel";

import {
    RecentWorkItems,
} from "@/features/tasks/components/RecentWorkItems";

import {
    WorkItemStatusOverview,
} from "@/features/tasks/components/WorkItemStatusOverview";
...
import {
    EditProjectDialog,
} from "../components/EditProjectDialog";
...
import {
    ProjectAccessPanel,
} from "../components/overview/ProjectAccessPanel";

import {
    ProjectHeader,
} from "../components/overview/ProjectHeader";

import {
    ProjectOverviewMetrics,
} from "../components/overview/ProjectOverviewMetrics";

import {
    ProjectOverviewNavigation,
} from "../components/overview/ProjectOverviewNavigation";

import {
    ProjectReadOnlyBanner,
} from "../components/overview/ProjectReadOnlyBanner";
...
export function ProjectOverviewPage() {
    ...
    const [
        ...
        useState<ProjectActionTarget | null>(
            null
        );
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Parent Workspace and Project Mismatch
    |--------------------------------------------------------------------------
    */
    ...
    */
    ...
    const canViewProjectInvitations =
        role ===
        "admin";

    const canCancelProjectInvitations =
        role ===
        "admin";
                ...
                <div className="space-y-5 xl:col-span-9">
                    ...
                    <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
                        ...
                        <PendingProjectInvitationsPanel
                            ...
                            canView={
                                canViewProjectInvitations
                            }
                            canCancel={
                                canCancelProjectInvitations
                            }
                        />
                    </div>
