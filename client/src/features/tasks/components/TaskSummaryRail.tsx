    ...
    return (
      <div className="rounded-xl border border-border bg-surface/60 p-4 shadow-soft">
        ...
        <DashboardSectionError
          ...
          message={
            errorMessage ??
            "Unable to load the task summary."
          }
          onRetry={
            onRetry
          }
                      ...
                      (
                        ...
                        >
                          <span className="flex items-center gap-1.5 text-foreground">
                            <span
                              className={
                                `h-2 w-2 shrink-0 rounded-full ${PRIORITY_DOT[priority]}`
                              }
                              aria-hidden
                            />
                            {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            <span
                              className={
                                `shrink-0 text-xs ${isTaskOverdue(item, now) ? "font-medium text-danger" : "text-muted"}`
                              }
                            >
                              {
                                item.dueDate
