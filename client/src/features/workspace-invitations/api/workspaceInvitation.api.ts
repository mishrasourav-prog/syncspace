...
import type {
  InvitationRole,
  WorkspaceInvitation,
} from "../workspaceInvitation.types";
...
export async function inviteWorkspaceMemberRequest(
  ...
  return axiosClient
    .post<ApiResponse<WorkspaceInvitation>>(
...
export async function getMyInvitationsRequest(): Promise<
  WorkspaceInvitation[]
> {
  return axiosClient
    .get<ApiResponse<{ invitations: WorkspaceInvitation[] }>>(
