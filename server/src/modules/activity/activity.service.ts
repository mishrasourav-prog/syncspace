...
export class ActivityService {
    ...
    */
    ...
    return {
        ...
        workspace:
            activity.workspace.toString(),

        project:
            activity.project.toString(),
    ...
    /*
    |--------------------------------------------------------------------------
    | Internal Activity Creation
    |--------------------------------------------------------------------------
    |
    | This method is called by trusted domain-event subscribers.
    | It is not exposed directly through an HTTP controller.
    |
    */
