...
class DiscussionController {
    ...
    async getProjectDiscussions(
        ...
        try {
            ...
            const query =
                getDiscussionsQuerySchema.parse(
                    req.query
                );
    ...
    async updateDiscussion(
        ...
        try {
            ...
            const data =
                updateDiscussionBodySchema.parse(
                    req.body
                );
    ...
    async createReply(
        ...
        try {
            ...
            const data =
                createDiscussionReplyBodySchema.parse(
                    req.body
                );
    ...
    async getReplies(
        ...
        try {
            ...
            const query =
                getDiscussionRepliesQuerySchema.parse(
                    req.query
                );
    ...
    async updateReply(
        ...
        try {
            const {
                ...
                replyIdParamSchema.parse(
                    req.params
                );

            const data =
                updateDiscussionReplyBodySchema.parse(
                    req.body
                );
