...
discussionRouter.get(
  "/projects/:projectId/discussions",
  discussionController.getProjectDiscussions.bind(discussionController),
);
...
discussionRouter.patch(
  ...
  discussionController.unpinDiscussion.bind(discussionController),
);
...
discussionRouter.patch(
  ...
  discussionController.unlockDiscussion.bind(discussionController),
);

discussionRouter.post(
  "/discussions/:discussionId/replies",
  discussionController.createReply.bind(discussionController),
);

discussionRouter.get(
  "/discussions/:discussionId/replies",
  discussionController.getReplies.bind(discussionController),
);

discussionRouter.patch(
  "/discussion-replies/:replyId",
  discussionController.updateReply.bind(discussionController),
);

discussionRouter.delete(
  "/discussion-replies/:replyId",
  discussionController.deleteReply.bind(discussionController),
);
