...
export const registerNotificationSubscribers = (): void => {
    ...
    eventBus.subscribe(
        ...
        async (event) => {
            ...
            const itemLabel =
                event.payload.taskType === TaskType.ISSUE
                    ? "Issue"
                    : "Task";
    ...
    eventBus.subscribe(
        ...
        async (event) => {
            ...
            await notificationService.createAndPublishNotification({
                ...
                message:
                    `Your role in “${workspace.name}” was changed to ${event.payload.role}.`,
                workspaceId:
                    event.payload.workspaceId,
                entityType:
    ...
    eventBus.subscribe(
        ...
        async (event) => {
            ...
            await notificationService.createAndPublishNotification({
                ...
                message:
                    `Your role in “${project.name}” was changed to ${event.payload.role}.`,
                workspaceId:
                    event.payload.workspaceId,
                projectId:
                    event.payload.projectId,
    ...
    eventBus.subscribe(
        ...
        async (event) => {
            ...
            await notificationService.createAndPublishNotification({
                ...
                message:
                    `${joinedUser.name} joined “${workspace.name}”.`,
                workspaceId:
                    event.payload.workspaceId,
                entityType:
                    NotificationEntityType.WORKSPACE,
    ...
    eventBus.subscribe(
        ...
        async (event) => {
            ...
            await notificationService.createAndPublishNotification({
                ...
                message:
                    `${joinedUser.name} joined “${project.name}”.`,
                workspaceId:
                    event.payload.workspaceId,
                projectId:
                    event.payload.projectId,
