...
export class TaskCommentService {
    ...
    */
    ...
    private mapComment(
        ...
        return {
            ...
            /*
            Never expose the original body of a
            soft-deleted comment.
            */
            body: comment.isDeleted
    ...
    async createComment(
        ...
        */
        ...
        if (task.isArchived) {
            throw new ApiError(
                409,
                "Comments cannot be added to an archived task."
            );
        }
    ...
    */
    ...
    async getTaskComments(
        ...
        /*
        Archived tasks, projects and workspaces
        remain readable.

        Therefore, this method intentionally does
        not reject archived resources.
        */

        const filter:
            FilterQuery<ITaskCommentDocument> = {
                task:
                    task._id,
            };
    ...
    */
    ...
    async updateComment(
        ...
        This check happens before archive/deleted-state
        ...
        */
        ...
        if (task.isArchived) {
            throw new ApiError(
                409,
                "Comments cannot be edited on an archived task."
            );
        }
        ...
        |--------------------------------------------------------------------------
        |
        | Repeating the same update does not modify
        | isEdited or editedAt.
        |
        */
    ...
    */
    ...
    async deleteComment(
        ...
        Authorization is checked first, so another
        user cannot use this behavior to bypass permissions.
        */
